...
namespace DataAccess.Respository
{
    public class UserRepo : Repository<ApplicationUser>, IUserRepo
    {
        ...
        public UserRepo(ApplicationDbContext db, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, IOptions<JWT> jwt)  : base(db)
        {
            _db = db;
        ...
        public async Task<AuthViewModel> RegisterAsync(RegisterViewModel model)
        {
        ...
        public async Task<AuthViewModel> LoginAsync(LoginViewModel model)
        {
        ...
        public async Task<AuthViewModel> RefreshTokenAsync(string token)
        {
            var authModel = new AuthViewModel();
